...
plugins=(git sudo tmux systemd nmap httpie dirhistory fzf fzf-tab zsh-autosuggestions pip pipenv docker rsync)
...
alias colsandrows='stty -a | head -n1 | cut -d ";" -f 2-3 | cut -b2- | sed "s/; /\n/"'
